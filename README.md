...
```
rpm -Uvh https://github.com/vdar/syncthing-centos/releases/download/v0.14.20/syncthing-0.14.20-0.el7.centos.x86_64.rpm
```
...
cd ~/rpmbuild/SOURCES/
wget https://github.com/syncthing/syncthing/releases/download/v0.14.20/syncthing-linux-amd64-v0.14.20.tar.gz
cd ~/rpmbuild/SPECS/
