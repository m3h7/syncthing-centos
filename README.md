...
```
rpm -Uvh https://github.com/vdar/syncthing-centos/releases/download/v0.14.30/syncthing-0.14.30-0.el7.centos.x86_64.rpm
```
...
cd ~/rpmbuild/SOURCES/
wget https://github.com/syncthing/syncthing/releases/download/v0.14.30/syncthing-linux-amd64-v0.14.30.tar.gz
cd ~/rpmbuild/SPECS/
